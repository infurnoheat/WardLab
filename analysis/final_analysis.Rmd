...
H3K27ac_merged_cor <- H3K27ac_merged %>% 
  dplyr::select(Geneid,contains("Ind")) %>% 
  column_to_rownames("Geneid") %>% 
  cpm(., log = TRUE) %>% 
  cor()
...
H3K27me3_merged_cor <- H3K27me3_merged %>% 
  dplyr::select(Geneid,contains("Ind")) %>% 
  column_to_rownames("Geneid") %>% 
  cpm(., log = TRUE) %>% 
  cor()
...
H3K36me3_merged_cor <- H3K36me3_merged %>% 
  dplyr::select(Geneid,contains("Ind")) %>% 
  column_to_rownames("Geneid") %>% 
  cpm(., log = TRUE) %>% 
  cor()
...
H3K9me3_merged_cor <- H3K9me3_merged %>% 
  dplyr::select(Geneid,contains("Ind")) %>% 
  column_to_rownames("Geneid") %>% 
  cpm(., log = TRUE) %>% 
  cor()
...
v1 <- volcanosig(V.24T.top, 0.05)+ ggtitle("DOX 24T")
v2 <- volcanosig(V.24R.top, 0.05)+ ggtitle("DOX 24R")+ylab("")
v3 <- volcanosig(V.144R.top, 0.05)+ ggtitle("DOX 144R")+ylab("")
plot_grid(v1,v2, v3, rel_widths =c(1,1,1))
```
...
#### H3K27ac
```{r H3K27ac PCA_var}
pca_H3K27ac <- calc_pca(H3K27ac_merged_raw)
#pca_H3K27ac <- pca_H3K27ac$x %>% cbind(.,H3K27ac_annomat)
#pca_var_plot(pca_H3K27ac, col_var = tx, shape_var = ind)
```

```{r H3K27ac PCA}
#pca_plot(pca_H3K27ac, col_var = )
```

#### H3K27me3
```{r H3K27me3 PCA_var}
#pca_H3K27me3 <- calc_pca(H3K27me3_merged_raw)
#pca_var_plot(pca_H3K27me3)
```

```{r H3K27me3 PCA}
#pca_plot(pca_H3K27me3)
```

#### H3K36me3
```{r H3K36me3 PCA_var}
#pca_H3K36me3 <- calc_pca(H3K36me3_merged_raw)
#pca_var_plot(pca_H3K36me3)
```

```{r H3K36me3 PCA}
#pca_plot(pca_H3K36me3)
```

#### H3K9me3
```{r H3K9me3 PCA_var}
#pca_H3K9me3 <- calc_pca(H3K9me3_merged_raw)
#pca_var_plot(pca_H3K9me3)
```

```{r H3K9me3 PCA}
#pca_plot(pca_H3K9me3)
```
